...
class DECA(nn.Module):
    ...
    def _setup_renderer(self, model_cfg):
        ...
        self.render = SRenderY(self.image_size, obj_filename=model_cfg.topology_path, files_dir=model_cfg.addfiles_path,
                               uv_size=model_cfg.uv_size, rasterizer_type=self.cfg.rasterizer_type).to(self.device)
